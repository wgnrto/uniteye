// Code changed by Tobias Wagner 07/2023 for the UnitEye project.
// Ulm University, Institute for Media Informatics
//
...
#pragma warning restore IDE0025
        ...
        public int GetCameraIndex()
        {
            ...
            {
                if (availableSources[i].name == sourceName)
                {
                    index = i;
                    break;
                }
        ...
        private void InitializeWebCamTexture()
        {
            ...
            if (webCamDevice is WebCamDevice valueOfWebCamDevice)
            {
                webCamTexture = new WebCamTexture(valueOfWebCamDevice.name, resolution.width, resolution.height, 0);
                return;
            }
